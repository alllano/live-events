...
export class EventService {
  ...
  /** Retrieves the occupancy report for a given event. */
  getOccupancyReport(eventId: number): Observable<OccupancyReportResponse> {
    return this.httpBaseService.get<OccupancyReportResponse>(`events/${eventId}/report`);
  }
